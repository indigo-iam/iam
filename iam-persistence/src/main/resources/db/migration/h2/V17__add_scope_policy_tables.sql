CREATE TABLE iam_scope (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, SCOPE VARCHAR(256) NOT NULL UNIQUE, PRIMARY KEY (ID));

CREATE TABLE iam_scope_policy (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, creation_time TIMESTAMP NOT NULL, description VARCHAR(512), 
