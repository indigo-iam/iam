...
CREATE TABLE iam_account_client (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, creation_time TIMESTAMP NOT NULL, account_id BIGINT NOT NULL, client_id BIGINT NOT NULL, PRIMARY KEY (id));
