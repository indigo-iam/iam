...
ALTER TABLE iam_exchange_scope_policies ADD CONSTRAINT FK_iam_exchange_scope_policies_exchange_policy_id 
	FOREIGN KEY (exchange_policy_id) REFERENCES iam_exchange_policy (ID);

INSERT INTO iam_exchange_policy(description, creation_time, last_update_time, rule, origin_m_type, dest_m_type)
	VALUES ('Allow all exchanges', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'PERMIT', 'ANY', 'ANY');