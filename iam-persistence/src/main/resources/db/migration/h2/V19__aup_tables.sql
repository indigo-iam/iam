CREATE TABLE iam_aup (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, 
...
CREATE TABLE iam_aup_signature (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, 
