...
INSERT INTO client_details (id, client_id, client_secret, client_name, dynamically_registered,
  ...
  (1, 'client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Test Client', false, 86400, 3600, 600, true, 'SECRET_BASIC',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (2, 'tasks-app', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Tasks App', false, null, 0, 0, true, 'SECRET_BASIC',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (3, 'post-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Post client', false, 86400, 3600, 600, true, 'SECRET_POST',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (4, 'client-cred', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Client credentials', false, 86400, 3600, 600, true, 'SECRET_BASIC',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (5, 'password-grant', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Password grant client', false, 86400, 3600, 600, true, 'SECRET_BASIC',true, null, CURRENT_TIMESTAMP(), 'optional', true),
  (6, 'scim-client-ro', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'SCIM client (read-only)', false, 86400, 3600, 600, true, 'SECRET_BASIC',false, 600, CURRENT_TIMESTAMP(), 'optional', true),
  (7, 'scim-client-rw', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'SCIM client (read-write)', false, 86400, 3600, 600, true, 'SECRET_BASIC',false, 600, CURRENT_TIMESTAMP(), 'optional', true),
  (8, 'token-exchange-actor', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Token Exchange grant client actor', false, 86400, 3600, 600, true, 'SECRET_BASIC',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (9, 'token-exchange-subject', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Token Exchange grant client subject', false, 86400, 3600, 600, true, 'SECRET_POST',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (10, 'registration-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Registration service test client', false, 86400, 3600, 600, true, 'SECRET_BASIC',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (11, 'token-lookup-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Token lookup client', false, 86400, 3600, 600, true, 'SECRET_BASIC', false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (12, 'device-code-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Device code client', false, 86400, 3600, 600, true, 'SECRET_BASIC', false, 600, CURRENT_TIMESTAMP(), 'optional', true),
  ...
  (17, 'admin-client-ro', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Admin client (read-only)', false, 86400, 3600, 600, true, 'SECRET_POST',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (18, 'admin-client-rw', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Admin client (read-write)', false, 86400, 3600, 600, true, 'SECRET_BASIC',false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (19, 'public-client', null, 'Public client', false, 3600, 3600, 600, true, 'NONE', false, null, CURRENT_TIMESTAMP(), 'optional', true),
  (20, 'refresh-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Refresh Flow client', false, 36000, 3600, 600, true, 'SECRET_BASIC', true, 30, CURRENT_TIMESTAMP(), 'optional', true),
  (21, 'protected-resource', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Protected Resource allowed only to introspect', false, 0, 0, 0, true, 'SECRET_BASIC', true, 0, CURRENT_TIMESTAMP(), 'optional', true),
  (22, 'whitelist-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Client which is not requiring confirmation access', false, 0, 0, 0, true, 'SECRET_BASIC', true, 0, CURRENT_TIMESTAMP(), 'optional', true),
  (23, 'public-client-with-secret', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Public client with secret', false, 3600, 3600, 600, false, 'NONE', false, 600, CURRENT_TIMESTAMP(), 'optional', true),
  (24, 'pkce-s256-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Client with PKCE S256', false, 3600, 3600, 600, false, 'SECRET_BASIC', false, 600, CURRENT_TIMESTAMP(), 'S256', true),
  (25, 'pkce-plain-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Client with PKCE plain', false, 3600, 3600, 600, false, 'SECRET_BASIC', false, 600, CURRENT_TIMESTAMP(), 'plain', true),
  (26, 'pkce-none-client', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Client with PKCE none', false, 3600, 3600, 600, false, 'SECRET_BASIC', false, 600, CURRENT_TIMESTAMP(), 'none', true),
  (27, 'https://federated-client.com', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'Federated client', false, 86400, 3600, 600, true, 'SECRET_BASIC', false, null, CURRENT_TIMESTAMP(), 'optional', true);
...
INSERT INTO client_details (id, client_id, client_secret, client_name, dynamically_registered,
  ...
  (15, 'jwt-auth-client_secret_jwt', 'Tt10zY1V/25RmejKOyMbyILuRLFMkyjTiBofKlDgP7U=', 'JWT Bearer Auth Client (client_secret_jwt)', 
  false, 86400, 3600, 600, true, 'SECRET_JWT', false, 'HS256', null),
  (16, 'jwt-auth-private_key_jwt', '+0s0fWiUxS97R4n/RSTQhhPUdjXPX17Xpa9RbSNxUvc=', 'JWT Bearer Auth Client (private_key_jwt)', 
