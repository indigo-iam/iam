...
public interface IamOAuthRefreshTokenRepository
  ...
  @Query("select r from OAuth2RefreshTokenEntity r where r.tokenValue = :value")
  Optional<OAuth2RefreshTokenEntity> findByTokenValue(@Param("value") String tokenValue);
  ...
  List<OAuth2RefreshTokenEntity> findRefreshTokensForUser(@Param("userId") String userId);
