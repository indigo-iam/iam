...
@Converter
public class IamJWKSetStringConverter implements AttributeConverter<JWKSet, String> {

  private static Logger logger = LoggerFactory.getLogger(IamJWKSetStringConverter.class);
