...
public class IamTokenRepositoryTests {
  ...
  public void testAuthenticationHolderScopesLinkedToAccessAndRefreshTokens() {
    ...
    assertFalse(authenticationHolderRepo.getById(aht.getId()).getScope().contains("iam:admin.read"));
    ...
    assertFalse(authenticationHolderRepo.getById(ahr.getId()).getScope().contains("iam:admin.read"));
  }
}
