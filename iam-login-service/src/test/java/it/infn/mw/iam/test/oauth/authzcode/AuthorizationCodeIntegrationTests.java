...
public class AuthorizationCodeIntegrationTests {
  ...
  public void testFilteredResourceIndicator() throws IOException, ParseException {
    ...
    // @formatter:off
      ValidatableResponse resp3= RestAssured.given()
        ...
        .formParam("code", authzCode)
        .formParam("state", "1")
        .formParam("resource", "http://example1.org http://example3.com")
        .auth()
          .preemptive()
            .basic(TEST_CLIENT_ID, TEST_CLIENT_SECRET)
      .when()
  ...
  public void testFilteredResourceIndicatorWithAudRequest() throws IOException, ParseException {
    ...
    // @formatter:off
      ValidatableResponse resp3= RestAssured.given()
        ...
        .formParam("code", authzCode)
        .formParam("state", "1")
        .formParam("audience", "http://example1.org http://example3.com")
        .auth()
          .preemptive()
            .basic(TEST_CLIENT_ID, TEST_CLIENT_SECRET)
      .when()
  ...
  @Test
  public void testResourceIndicatorRTFlowBoundToAuthzCode()
      throws IOException, ParseException {
