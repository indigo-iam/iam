...
public class CernTestSupport {
  ...
  public static final String MOCK_HR_AFFILIATION = "INFN";
  public static final Date MOCK_HR_USER_PARTICIPATION_START =
  ...
  public static final String VO_PERSON_API_URL = String.format("%s/api/VOPersons", HR_API_URL);
