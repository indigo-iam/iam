...
public class RegistrationRequestCertificateOffTests {
    ...
    @Test
    public void testVerifyNoCertificateRegisterCertificateTrue() throws Exception {
    ...
    @Test
    public void testVerifyMultipleRegistrationsNoCertificate() throws Exception {
    ...
    @Test
    public void testVerifyMultipleCertificateNoneRegistered() throws Exception {
