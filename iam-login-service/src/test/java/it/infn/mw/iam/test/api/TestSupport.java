...
public class TestSupport {
    ...
    public static LabelDTO TEST_LABEL = LabelDTO.builder().prefix(LABEL_PREFIX).name(LABEL_NAME).value(LABEL_VALUE)
            .build();

    public static final TypeReference<List<LabelDTO>> LIST_OF_LABEL_DTO = new TypeReference<List<LabelDTO>>() {
    };

    public static final ResultMatcher INVALID_PREFIX_ERROR_MESSAGE = jsonPath("$.error",
            containsString("invalid prefix (does not match"));

    public static final ResultMatcher PREFIX_TOO_LONG_ERROR_MESSAGE = jsonPath("$.error",
            containsString("invalid prefix length"));

    public static final ResultMatcher NAME_REQUIRED_ERROR_MESSAGE = jsonPath("$.error",
            containsString("name is required"));

    public static final ResultMatcher INVALID_NAME_ERROR_MESSAGE = jsonPath("$.error",
            containsString("invalid name (does not match"));
    ...
    public static final ResultMatcher NAME_TOO_LONG_ERROR_MESSAGE = jsonPath("$.error",
            containsString("invalid name length"));

    public static final ResultMatcher VALUE_TOO_LONG_ERROR_MESSAGE = jsonPath("$.error",
            containsString("invalid value length"));
