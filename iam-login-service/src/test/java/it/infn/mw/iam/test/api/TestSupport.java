...
public class TestSupport {
    ...
    public static final ResultMatcher INVALID_VALUE_ERROR_MESSAGE =
            jsonPath("$.error", containsString(
                    "Invalid label: The string must not contain any new line or carriage return"));
