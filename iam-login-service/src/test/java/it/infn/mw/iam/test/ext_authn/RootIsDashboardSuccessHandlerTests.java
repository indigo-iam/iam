...
public class RootIsDashboardSuccessHandlerTests {
  ...
  @Test
  void testSavedRequestToBaseUrlRedirectsToDashboard() throws ServletException, IOException {
  ...
  @Test
  void testOtherRequestIsIgnored() throws ServletException, IOException {
  ...
  @Test
  void whenNoRequestIsSavedGoToDashboard() throws ServletException, IOException {
