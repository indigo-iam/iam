...
class RegistrationRequestCertificateRequiredTests {
  ...
  private static final String TEST_1_SUBJECT = "C=IT, O=IGI, CN=test1";
  private static final String TEST_1_ISSUER = "C=IT, O=IGI, CN=test1";
  ...
  @Test
  void testVerifySucessRegisterCertificate() throws Exception {
    ...
    List<IamRegistrationRequest> requests = iamRequestRepo
      .findByStatus(IamRegistrationRequestStatus.NEW)
      .orElseThrow(
          () -> new AccountNotFoundException("Can not remove suspended account as none is found"));
  ...
  @Test
  void testVerifySucessRegisterCertificate2() throws Exception {
    ...
    IamAccount account =
        iamAccountRepo.findByUsername(USERNAME_2).orElseThrow(AccountNotFoundException::new);
  ...
  @Test
  void testVerifySucessRegisterCertificateValueFalse() throws Exception {
  ...
  @Test
  void testVerifyMultipleRegisterCertificate() throws Exception {
    ...
    account = iamAccountRepo.findByUsername(USERNAME_2).orElseThrow(AccountNotFoundException::new);
  ...
  @Test
  void testVerifyErrorRegisterSameCertificate() throws Exception {
  ...
  @Test
  void testRegistrationConfigRequireCertificate() throws Exception {
