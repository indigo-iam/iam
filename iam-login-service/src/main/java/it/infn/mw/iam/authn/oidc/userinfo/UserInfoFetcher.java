 ...
 */
package it.infn.mw.iam.authn.oidc.userinfo;
...
import it.infn.mw.iam.authn.oidc.model.ServerConfiguration.UserInfoTokenMethod;
...
public class UserInfoFetcher {
  ...
  private LoadingCache<PendingOIDCAuthenticationToken, IamUserInfo> cache;
  ...
  public IamUserInfo loadUserInfo(final PendingOIDCAuthenticationToken token) {
    try {
  ...
  private class UserInfoLoader extends CacheLoader<PendingOIDCAuthenticationToken, IamUserInfo> {
    ...
    @Override
    public IamUserInfo load(final PendingOIDCAuthenticationToken token) throws URISyntaxException {
      ...
      if (!Strings.isNullOrEmpty(userInfoString)) {
        ...
        IamUserInfo userInfo = fromJson(userInfoJson);
        return userInfo;
      }
  ...
  protected IamUserInfo fromJson(JsonObject userInfoJson) {

    return IamUserInfo.fromJson(userInfoJson);
  }
}
