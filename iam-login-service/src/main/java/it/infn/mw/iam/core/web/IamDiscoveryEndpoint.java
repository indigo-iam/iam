...
public class IamDiscoveryEndpoint {
   ...
   */
  private static final Logger logger = LoggerFactory.getLogger(IamDiscoveryEndpoint.class);
  ...
  public String providerConfiguration(Model model) {
    ...
    m.put("introspection_endpoint", baseUrl + IntrospectionEndpoint.URL);
    m.put("revocation_endpoint", baseUrl + RevocationEndpoint.URL);
