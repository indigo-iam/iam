...
@RestController
@RequestMapping(value = {ProtectedResourceRegistrationApiController.PROTECTED_RESOURCE_ENDPOINT})
public class ProtectedResourceRegistrationApiController {

  public static final String PROTECTED_RESOURCE_ENDPOINT = "/resource";

  private final ClientRegistrationService service;

  public ProtectedResourceRegistrationApiController(ClientRegistrationService service) {
    this.service = service;
  }

  @PostMapping
  @ResponseStatus(code = CREATED)
  public RegisteredClientDTO registerProtectedResource(@RequestBody RegisteredClientDTO request,
  ...
  @PutMapping("/{clientId}")
  @JsonView({ClientViews.NoSecretDynamicRegistration.class})
  public RegisteredClientDTO updateProtectedResource(@PathVariable String clientId,
      @RequestBody RegisteredClientDTO request, Authentication authentication)
      throws ParseException {
    return service.updateProtectedResource(clientId, request, authentication);
  }
  ...
  @JsonView({ClientViews.NoSecretDynamicRegistration.class})
  public RegisteredClientDTO redeemProtectedResource(@PathVariable String clientId,
