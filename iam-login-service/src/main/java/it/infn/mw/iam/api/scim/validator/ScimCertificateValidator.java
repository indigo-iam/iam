 ...
 */
package it.infn.mw.iam.api.scim.validator;
...
public class ScimCertificateValidator
        implements ConstraintValidator<ScimCertificate, ScimX509Certificate> {

    @Autowired
    private X509CertificateParser parser;

    public ScimCertificateValidator() {
        // empty
    }

    @Override
    public void initialize(ScimCertificate constraintAnnotation) {
        // empty
    }

    private boolean missingPemAndDn(ScimX509Certificate value) {
    ...
    private boolean inconsistentSubject(ScimX509Certificate value, IamX509Certificate cert) {
    ...
    private boolean inconsistentIssuer(ScimX509Certificate value, IamX509Certificate cert) {
    ...
    @Override
    public boolean isValid(ScimX509Certificate value, ConstraintValidatorContext context) {
