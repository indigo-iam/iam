...
public class KeycloakScopeClaimTranslationService extends BaseScopeClaimTranslationService {

  @Override
  public Set<String> getClaimsForScope(String scope) {

    switch (scope) {
      case KeycloakOidcScopes.KEYCLOAK:
        return Sets.newHashSet(KeycloakExtraClaimNames.ROLES);
      case OidcScopes.PROFILE:
        Set<String> claims = super.getClaimsForScope(scope);
        claims.add(KeycloakExtraClaimNames.ROLES);
        return claims;
      default:
