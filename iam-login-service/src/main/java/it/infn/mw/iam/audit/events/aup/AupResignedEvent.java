...
public class AupResignedEvent extends IamAuditApplicationEvent {
  ...
  public AupResignedEvent(Object source, IamAupSignature signature) {
    super(IamEventCategory.AUP, source, format("User %s re-signed the AUP", 
