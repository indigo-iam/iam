            ...
            <%@ taglib prefix="t" tagdir="/WEB-INF/tags/iam" %>
                    ...
                    <t:page title="Log in">
                        <jsp:attribute name="footer">
                            ...
                            <script type="text/javascript"
                                src="/webjars/angular-animate/angular-animate.min.js"></script>
                            <script type="text/javascript"
                                src="/webjars/angular-ui-bootstrap/dist/ui-bootstrap-tpls.js"></script>
                            <script type="text/javascript"
                                src="${resourcesPrefix}/iam/js/passwordreset.app.js"></script>
                            <script type="text/javascript"
                                src="${resourcesPrefix}/iam/js/service/passwordreset.service.js"></script>
                            <script type="text/javascript"
                                src="${resourcesPrefix}/iam/js/controller/passwordreset.controller.js"></script>
                            <script type="text/javascript">
                  ...
                  and param.sll == null
                            ...
                            <div id="login-external-authn" class="${containerSpacer}">
                              ...
                              and (
                                ...
                                <c:forEach items="${loginPageConfiguration.externalAuthnOptionsOrder}"
                                    var="externalAuthnMethodName">
                                    <c:choose>
                                        ...
                                        <c:when test="${externalAuthnMethodName == 'OIDC'}">
                                            <c:if test="${loginPageConfiguration.oidcEnabled}">
                                                <c:forEach items="${loginPageConfiguration.oidcProviders}"
                                                    var="provider">
                                                    <t:loginButton cssClass="ext-authn-login-button"
                                ...
                                <c:if
                                    test="${loginPageConfiguration.showLinkToLocalAuthenticationPage and param.sll == null}">
                ...
                (
                  ...
                  or param.sll != null
                            ...
                            <c:if
                                test="${loginPageConfiguration.registrationEnabled && loginPageConfiguration.showRegistrationButton}">

                                <div id="login-registration">
                                    <div class="registration-preamble text-muted">
                                        Not a member?
                                    </div>
                                    <a class="btn btn-success btn-block" href="/start-registration">Apply for an
                                        account</a>
                                    <c:if test="${
                    ...
                    && iamSamlProperties.wayfLoginButton.image.url.contains('edugain-logo.gif')
                                        ...
                                        <!-- WAYF login button -->
                                        <a class="btn btn-success btn-block" href="/saml/login">Register an account with
                                            eduGAIN</a>
                                    </c:if>
                                </div>
                            </c:if>
