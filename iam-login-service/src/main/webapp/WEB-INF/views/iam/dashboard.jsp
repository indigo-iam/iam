...
<body id="body" class="skin-blue" ng-app="dashboardApp" ng-cloak style="display: none">
  ...
  <script type="text/javascript" src="${resourcesPrefix}/iam/apps/dashboard-app/controllers/user-manager-privileges.controller.js"></script>
  ...
  <script type="text/javascript"
    src="${resourcesPrefix}/iam/apps/dashboard-app/components/user/user-manager-privileges/user.user-manager-privileges.component.js"></script>
  <script type="text/javascript"
  ...
  <script type="text/javascript" src="${resourcesPrefix}/iam/apps/dashboard-app/components/clients/client/resetclient/confirmresetclient.component.js"></script>
