...
angular.module('activateMfaApp').factory('ActivateMfaService', ActivateMfaService);

ActivateMfaService.$inject = ['$http', '$httpParamSerializerJQLike'];

function ActivateMfaService($http, $httpParamSerializerJQLike) {
