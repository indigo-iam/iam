CREATE TABLE iam_reg_request (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, UUID VARCHAR(36) NOT NULL UNIQUE, CREATIONTIME TIMESTAMP NOT NULL, ACCOUNT_ID BIGINT, STATUS VARCHAR(50), LASTUPDATETIME TIMESTAMP, PRIMARY KEY (ID));
